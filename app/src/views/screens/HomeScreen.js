...
export default function HomeScreen({navigation}) {
  ...
  // const categories = ["All","popular", "subscribe" , "Subscribed",];
  ...
  //         <View><Text style = {{...styles.categoryListText, color: selectedCategoryIndex === index ? "black" : "grey"}}>{item}</Text>
  //         {selectedCategoryIndex == index &&  (
  //             <View style = {{height:3 , width:30 ,backgroundColor :"black", marginTop :2}}></View>
